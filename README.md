...
<img src="https://www.image2url.com/r2/default/images/1776338825845-caa56d77-b8dd-46d7-8380-753c6519a578.jpg" alt="GitHub CDN Logo" width="120" style="border-radius:50%"/>
...
[![Live Demo](https://img.shields.io/badge/Live%20Demo-ghbcdn.clevertechnexus.qzz.io-brightgreen?style=for-the-badge)](https://ghbcdn.clevertechnexus.qzz.io)
...
[Live Demo](https://ghbcdn.clevertechnexus.qzz.io) • [Storage Repo](https://github.com/clevertechnexus2/ghbcdn) • [Report Bug](https://github.com/clevertechnexus2/github-cdn/issues) • [WhatsApp Channel](https://whatsapp.com/channel/0029Vb73SRl1CYoLWtyr4u1X)
...
```
        ...
        │  clevertechnexus2/ghbcdn@main/image/Xy3-photo.jpg       │
        └────────────────────────────────────────────────────┘
```
...
| Page | URL |
| --- | --- |
| Upload UI | <https://ghbcdn.clevertechnexus.qzz.io> |
| Storage Repo | <https://github.com/clevertechnexus2/ghbcdn> |
...
```bash
git clone https://github.com/clevertechnexus2/github-cdn.git
cd github-cdn
```
...
> Live demo base URL: `https://ghbcdn.clevertechnexus.qzz.io`
...
```bash
curl -X POST https://ghbcdn.clevertechnexus.qzz.io/api/upload.php \
...
const res = await fetch('https://ghbcdn.clevertechnexus.qzz.io/api/upload.php', {
  method: 'POST',
  body: form
});
...
with open('photo.jpg', 'rb') as f:
    r = requests.post(
        'https://ghbcdn.clevertechnexus.qzz.io/api/upload.php',
        files={'file': f}
    )
print(r.json()['rawUrl'])
```
...
{
  "success": true,
  "rawUrl": "https://cdn.jsdelivr.net/gh/clevertechnexus2/ghbcdn@main/image/Xy3-photo.jpg"
}
```
...
### 🔽 Delete a File — `DELETE /CleverDelete.php`
...
```bash
curl -X DELETE https://ghbcdn.clevertechnexus.qzz.io/CleverDelete.php \
...
### 🌐 Web Upload Endpoint — `POST /CleverUpload.php`
...
| `GITHUB_USERNAME` | ✅ | `clevertechnexus2` | Your GitHub username |
...
- [ ] Optional delete key per upload (like Clever CDN) for API-based deletion without CAPTCHA
...
```
MIT © 2024 - Present  Clever Tech Nexus / Clever Tech
```
...
**Clever Tech Nexus** — *Founder, Clever Tech*

- 🌐 Website: <https://me.clevertechnexus.qzz.io>
- 🚀 Live CDN: <https://ghbcdn.clevertechnexus.qzz.io>
- 💼 GitHub: [@mauricegift](https://github.com/clevertechnexus2)
- 📧 Email: [founder@giftedtech.co.ke](mailto:founder@clevertechnexus.qzz.io)
- 💬 WhatsApp Channel: [Follow for updates](https://whatsapp.com/channel/0029Vb73SRl1CYoLWtyr4u1X)
